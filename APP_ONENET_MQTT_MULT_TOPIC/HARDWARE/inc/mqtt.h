...
#define  R_NUM               12    //接收缓冲区个数
#define  RBUFF_UNIT          40   //接收缓冲区长度

#define  T_NUM               10    //发送缓冲区个数  
#define  TBUFF_UNIT          100   //发送缓冲区长度

#define  C_NUM               12    //命令缓冲区个数
#define  CBUFF_UNIT          40   //命令缓冲区长度
